...
def main(args, extras) -> None:
    ...
    if args.typecheck:
        ...
        install_import_hook("up2you", "typeguard.typechecked")

    from up2you.systems.base import BaseSystem
    from up2you.utils.callbacks import (
        CodeSnapshotCallback,
        ConfigSnapshotCallback,
        CustomProgressBar,
        ProgressCallback,
    )
    from up2you.utils.config import ExperimentConfig, load_config
    from up2you.utils.core import find
    from up2you.utils.misc import get_rank, time_recorder
    from up2you.utils.typing import Optional
    ...
    if args.train:
        ...
        if args.wandb:
            wandb_logger = WandbLogger(
                project="UP2You", name=f"{cfg.name}-{cfg.tag}"
            )
