...
from thirdparties.hybrik.models.simple3dpose import HybrIKBaseSMPLCam
from thirdparties.pixielib.utils.config import cfg as pixie_cfg
from thirdparties.pixielib.pixie import PIXIE
import thirdparties.smplx as smplx
from thirdparties.pare.pare.core.tester import PARETester
from thirdparties.pymaf.utils.geometry import rot6d_to_rotmat, batch_rodrigues, rotation_matrix_to_angle_axis
from thirdparties.pymaf.utils.imutils import process_image
from thirdparties.common.imutils import econ_process_image
from thirdparties.pymaf.core import path_config
from thirdparties.pymaf.models import pymaf_net
from thirdparties.common.config import cfg
from thirdparties.common.render import Render
from thirdparties.dataset.body_model import TetraSMPLModel
from thirdparties.dataset.mesh_util import get_visibility, SMPLX
...
if __name__ == '__main__':
    ...
    cfg.merge_from_file('./thirdparties/pymaf/configs/pymaf_config.yaml')
