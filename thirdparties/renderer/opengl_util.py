...
from thirdparties.renderer.mesh import load_scan, compute_tangent, compute_normal, load_obj_mesh_mtl
from thirdparties.dataset.mesh_util import projection
from thirdparties.renderer.gl.prt_render import PRTRender
from thirdparties.renderer.camera import Camera
import os
import cv2
import math
import random
